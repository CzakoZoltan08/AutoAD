...
class Preprocessor(object):
    ...
    def sequence(self, data, labels=None, verbose=False):
        """Transform pandas DataFrame into DeepCASE sequences.
            ...
            labels : torch.Tensor of shape=(n_samples,)
                Labels will be None if no labels parameter is given,
                and if data
            ...
            mapping : dict()
                ...
                difficult for a one-hot encoding to deal with. Therefore,
                 we map
    ...
    def csv(self, path, nrows=None, labels=None, verbose=False):
        """Preprocess data from csv file.
            ...
            Note
            ----
            **Format**: The assumed format of a .csv file is that
            the first line
    ...
    def text(self, path, nrows=None, labels=None, verbose=False):
        """Preprocess data from text file.
            ...
            **Format**: The assumed format of a text file is that each line in
            the text file contains a space-separated
            sequence of event IDs for a
            machine. I.e. for *n* machines, there will be *n*
            lines in the file.
